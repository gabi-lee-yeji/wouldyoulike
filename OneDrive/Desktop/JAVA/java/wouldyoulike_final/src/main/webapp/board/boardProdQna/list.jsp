...
%>
							<td>제품명: <a href="/wouldyoulike_final/product/product.jsp?productN=<%=pdto.getProductN()%>"><img src="/wouldyoulike_final/img/prouct/<%=pdto.getImg()%>" height="32" > <%=pdto.getName() %></a> </td> 
<%						}else{ %>
